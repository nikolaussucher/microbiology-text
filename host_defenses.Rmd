...
knitr::include_graphics("./figures/host_defenses/Blausen_0623_LymphaticSystem_Female.png")
```
...
knitr::include_graphics("./figures/host_defenses/Illu_thymus.jpg")
```
...
knitr::include_graphics("./figures/host_defenses/Illu_spleen.jpg")
```
...
knitr::include_graphics("./figures/host_defenses/Schematic_of_lymph_node_showing_lymph_sinuses.svg")
```
...
knitr::include_graphics("./figures/host_defenses/2202_Lymphatic_Capillaries_big.png")
```
...
knitr::include_graphics("./figures/host_defenses/Nutrient_absorbtion_to_blood_and_lymph.png")
```
...
```{r inflammation, fig.cap='(ref:infl)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/host_defenses/Events_in_Acute_Inflammation.pdf")
```
...
```{r pldm, out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
setwd("~/Dropbox/R/microbiology-text")

macro <-  as_tibble(read.csv("data/plasma_derived_mediators.csv"))

knitr::kable(macro, col.names = c("Name", "Produced by", "Description"), digits = 2, align = 'lll', booktabs = TRUE, caption = "Plasma-derived mediators of inflammation.") %>% kable_styling(latex_options = c("striped", "hold_position")) 
```
...
```{r cdm, out.width='75%', echo=FALSE, message=FALSE, warning=FALSE}
library(tidyverse)
library(printr)        
library(kableExtra)
setwd("~/Dropbox/R/microbiology-text")

macro <-  as_tibble(read.csv("data/cell_derived_mediators.csv"))

knitr::kable(macro, col.names = c("Name", "Type", "Source", "Description"), digits = 2, align = 'llll', booktabs = TRUE, caption = "Cell-derived mediators of inflammation") %>% kable_styling(latex_options = c("striped", "hold_position")) 
```
...
knitr::include_graphics("./figures/host_defenses/Phagocytosis2.png")
```
...
knitr::include_graphics("./figures/host_defenses/Complement_pathway.svg")
```
...
knitr::include_graphics("./figures/host_defenses/SEM_blood_cells.jpg")
```
...
```{r leukocytes, fig.cap='(ref:leukoc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/host_defenses/Blausen_0909_WhiteBloodCells.png")
```
...
knitr::include_graphics("./figures/host_defenses/Neutrophil_with_anthrax_copy.jpg")
```
