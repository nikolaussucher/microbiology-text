...
```{r antibody, fig.cap='(ref:antibo)', echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Vaccination, fig.cap='(ref:vacc)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/adaptive_immunity/Vaccination-introduction-and-cases-or-deaths-scaled.jpg")
```
...
```{r rnavaccine, fig.cap='(ref:rnavac)', echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./figures/adaptive_immunity/RNA_vaccine-en.svg")
```
